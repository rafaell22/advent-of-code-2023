...
describe('Test game data parsing', () => {
  ...
  test('Succesfully return the minimum amount of cubes necessary to play a game with 1 set', () => {
    const game = new Game('Game 1: 4 red, 18 green, 15 blue');
    expect(game.minimumCubes()).toEqual(expect.objectContaining({ r: 4, g: 18, b: 15 }));
  });

  test('Succesfully return the minimum amount of cubes necessary to play a game with multiple set', () => {
    const game = new Game('Game 1: 4 red, 18 green, 15 blue; 17 green, 18 blue, 9 red; 8 red, 14 green, 6 blue; 14 green, 12 blue, 2 red');
    expect(game.minimumCubes()).toEqual(expect.objectContaining({ r: 9, g: 18, b: 18 }));
  });
});
